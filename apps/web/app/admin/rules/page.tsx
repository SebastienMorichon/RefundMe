            ...
            <form onSubmit={createRule} className="surface p-5 sm:p-6">
              ...
              <fieldset className="mt-5 border-t border-[#edf0f7] pt-5">
                ...
                <div className="mt-3 grid gap-2">
                  ...
                  {requiredDocuments.map((document, index) => <div key={`${document.kind}-${index}`} className="grid min-w-0 gap-2 sm:grid-cols-[120px_minmax(0,1fr)_auto_auto] sm:items-center">
